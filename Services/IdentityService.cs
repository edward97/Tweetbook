...
namespace Tweetbook.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        private readonly TokenValidationParameters _tokenValidationParamenters;
        ...
        public IdentityService(UserManager<IdentityUser> userManager, JwtSettings jwtSettings, TokenValidationParameters tokenValidationParameters, DataContext context)
        {
            ...
            _tokenValidationParamenters = tokenValidationParameters;
            _context = context;
        }
        ...
        private ClaimsPrincipal GetPrincipalFromToken(string token)
        {
            ...
            try
            {
                var principal = tokenHandler.ValidateToken(token, _tokenValidationParamenters, out var validatedToken);
